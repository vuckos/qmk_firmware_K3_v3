...
#    ifdef ENCODER_ENABLE
    ...
    palEnableLineEvent(encoders_pin_a[0], PAL_EVENT_MODE_BOTH_EDGES);
    palEnableLineEvent(encoders_pin_b[0], PAL_EVENT_MODE_BOTH_EDGES);
    palSetLineCallback(encoders_pin_a[0], encoders_pins_cb, NULL);
    palSetLineCallback(encoders_pin_b[0], encoders_pins_cb, NULL);
#    endif
#endif
